...
class UNet3Plus(nn.Module):
    def __init__(self, in_channels=1, out_channels=3, feature_scale=4, 
        ...
        self.up_concat4 = UpConvBlock(filters[4], filters[3], is_deconv)
        self.up_concat3 = UpConvBlock(filters[3], filters[2], is_deconv)
        self.up_concat2 = UpConvBlock(filters[2], filters[1], is_deconv)
        self.up_concat1 = UpConvBlock(filters[1], filters[0], is_deconv)
...
class UpConvBlock(nn.Module):
    def __init__(self, in_channels, out_channels, is_deconv):
        ...
        self.conv = ConvBlock(in_channels + out_channels, out_channels, True)
